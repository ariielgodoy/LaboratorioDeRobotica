###########################################################################
## Makefile generated for component 'calibracion_encoders'. 
## 
## Makefile     : calibracion_encoders.mk
## Generated on : Sun Nov 10 19:24:06 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/calibracion_encoders.elf
...
PRODUCT_NAME              = calibracion_encoders
MAKEFILE                  = calibracion_encoders.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/calibracion_encoders.elf
...
DEFINES_STANDARD = -DMODEL=calibracion_encoders -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ArduinoEncoder.o xcp_ext_mode.o calibracion_encoders.o calibracion_encoders_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/calibracion_encoders_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


%.S.o : $(START_DIR)/calibracion_encoders_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" $(subst /,\,"$<")
...
%.o : $(START_DIR)/calibracion_encoders_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" $(subst /,\,"$<")
...
calibracion_encoders.o : $(START_DIR)/calibracion_encoders_ert_rtw/calibracion_encoders.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


calibracion_encoders_data.o : $(START_DIR)/calibracion_encoders_ert_rtw/calibracion_encoders_data.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")


ert_main.o : $(START_DIR)/calibracion_encoders_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" $(subst /,\,"$<")
